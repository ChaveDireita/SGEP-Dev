...
namespace SGEP_Banco.Models
{
    public class ModelConverter
    {
        ...
        public static Almoxarifado DBToDomain (AlmoxarifadoDBModel almoxarifadoDB, IEnumerable<AlmoxarifadoMaterialDBModel> almoxarifadoMaterialDBs)
        {
            ...
            foreach (var am in almoxarifadoMaterialDBs)
